...
function SmallLoading(props) {
  return (
    <div className="loading-cont" style={{ position: props.position, top: props.top, left: props.left, height: props.heigth, transform: props.transform, position: props.position }}>
